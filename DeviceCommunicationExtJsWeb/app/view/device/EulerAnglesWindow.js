...
Ext.define('DeviceCommunication.view.device.EulerAnglesWindow', {
    extend: 'Ext.Window',
    alias: 'widget.eulerangleswindow',
    ...
    initComponent: function () {
        ...
        var store = Ext.create('Ext.data.JsonStore',
        {
            ...
            proxy: {
                ...
                api: { read: window.BaseUrl + "Devices/GetEulerAngles" },
                reader: {
                    type: 'json',
                    root: 'data',
                    totalProperty: 'total'
            ...
            items: [
                {
                    ...
                    features: [Ext.create('Ext.grid.feature.Grouping', {
                        groupHeaderTpl: 'Header Time - {[values.name]} ({rows.length} Row{[values.rows.length > 1 ? "s" : ""]})',
        ...
        DeviceCommunication.view.device.EulerAnglesWindow.superclass.initComponent.apply(this, arguments);
    }, //initComponent:
    getEulerAnglesGrid: function () {
        return this.items.get(0);
    },
    doRefreshData: function (imei) {
        this.getEulerAnglesGrid().store.getProxy().extraParams.imei = imei;
